<?php
	...
	require_once('../apsystem/tcpdf/tcpdf.php');  
    ...
    $pdf->AddPage(); 
    $contents = '';
	$employee_id='VSM709468325';
	$sql = "SELECT * FROM employee_rates er LEFT JOIN performance pe ON pe.id = er.part_id LEFT JOIN employees ON er.employee_id = employees.id WHERE er.date BETWEEN '$from' AND '$to' AND employees.employee_id = '$employee_id' ORDER BY employees.lastname ASC, employees.firstname ASC";
	...
	while($row = $query->fetch_assoc()){
		...
		$contents .= '
			<h2 align="center">TMAN Children Clothing </h2>
			...
			<table cellspacing="0" cellpadding="3">  
    	    	...
    	    	<tr> 
    	    		...
    	    		<td></td>
				 	...
				 	<td width="25%" align="right"><b>'.number_format($row['rate']).'</b></td>
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
