    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="performance_add.php">
                    <div class="form-group">
                        <label for="title" class="col-sm-3 control-label">Position</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="title" class="col-sm-3 control-label">Part</label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="performance_edit.php">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="performance_delete.php">
